...
$labelDefinitions = @(
    ...
    @{ Name = "comp: auth"; Color = "91c764"; Description = "Authentication (JWT signing and installation token management)" }
    @{ Name = "comp: client"; Color = "91c764"; Description = "GitHub API client and sub-clients" }
    @{ Name = "comp: events"; Color = "91c764"; Description = "Webhook event parsing and routing" }
    @{ Name = "comp: webhook"; Color = "91c764"; Description = "Webhook receiving and signature validation" }
    @{ Name = "comp: error"; Color = "91c764"; Description = "Error types and handling" }
